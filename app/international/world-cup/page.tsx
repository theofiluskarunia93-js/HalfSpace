...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title, description,
    alternates: { canonical: `${BASE_URL}/international/world-cup` },
    openGraph: { title, description, type: "website", url: `${BASE_URL}/international/world-cup`, siteName: "HalfSpace", images: [{ url: `${BASE_URL}/og-default.jpg`, width: 1200, height: 630, alt: "HalfSpace" }] },
...
export default function Page() {
  return (
    <LeaguePage
      ...
      description="Event olahraga terbesar di planet ini. Berita, analisis, dan momen bersejarah Piala Dunia."
