...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title, description,
    alternates: { canonical: `${BASE_URL}/international/copa-america` },
    openGraph: { title, description, type: "website", url: `${BASE_URL}/international/copa-america`, siteName: "HalfSpace", images: [{ url: `${BASE_URL}/og-default.jpg`, width: 1200, height: 630, alt: "HalfSpace" }] },
...
export default function Page() {
  return (
    <LeaguePage
      title="Copa America"
      description="Passion sepak bola Amerika Selatan. Berita, hasil pertandingan, dan analisis Copa America."
