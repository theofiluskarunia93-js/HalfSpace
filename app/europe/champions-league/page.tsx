...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title, description,
    alternates: { canonical: `${BASE_URL}/europe/champions-league` },
    openGraph: { title, description, type: "website", url: `${BASE_URL}/europe/champions-league`, siteName: "HalfSpace", images: [{ url: `${BASE_URL}/og-default.jpg`, width: 1200, height: 630, alt: "HalfSpace" }] },
